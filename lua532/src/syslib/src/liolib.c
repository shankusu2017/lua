...
static int f_seek (lua_State *L) {
  ...
  FILE *f = tofile(L);  //不要怀疑，这里的idx==1的参数就是file'hd，所以Lua中的调用必须是file:seek(mod, offset),或者是file.seek(file, mod, offset)
